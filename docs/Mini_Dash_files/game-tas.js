...
(function (Engine) {
    ...
    //@ts-ignore
    //window.addEventListener("keyu", Keyboard.onUp, false);
...
(function (Game) {
    ...
    Engine.System.onInit = function () {
        if (Engine.Data.useLocalStorage) {
            Engine.Data.setID("com", "noa", "minidash");
        }
        else {
            Engine.Data.setID("c", "n", "mdsh");
        }
...
(function (Game) {
    ...
    var SceneMap = /** @class */ (function (_super) {
        ...
        SceneMap.prototype.createSpriteTile = function (indexTile, x, y) {
            ...
            sprite.setFull(true, false, Game.Resources.textureMiniDash, this.xSizeTile, this.ySizeTile, 0, 0, xTexture, yTexture, this.xSizeTile, this.ySizeTile);
            return sprite;
        };
    ...
    var MainMenu = /** @class */ (function (_super) {
        ...
        function MainMenu() {
            ...
            if (Game.HAS_LINKS_NOADEV) {
                ...
                new Game.ColorDialog("normal", 0, _this.noadev.text.yAligned - 8 - 6 + 3 - 1 + 1 + 1 + 0.5 + 1, 52, 11);
            }
            var x = _this.xSizeMap * 0.5;
            var y = _this.ySizeMap * 0.5;
            Engine.Renderer.camera(x, y);
...
(function (Game) {
    ...
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("exit button", Game.Resources.textureMiniDash, 13, 270);
    });
...
(function (Game) {
    var FRAMES;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("music button", Game.Resources.textureMiniDash, 13, 270);
    });
...
(function (Game) {
    var FRAMES;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("pause button", Game.Resources.textureMiniDash, 13, 270);
    });
...
(function (Game) {
    var FRAMES;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("reset button", Game.Resources.textureMiniDash, 13, 270);
    });
...
(function (Game) {
    var FRAMES;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("sound button", Game.Resources.textureMiniDash, 13, 270);
    });
...
(function (Game) {
    ...
    var LevelText = /** @class */ (function (_super) {
        ...
        function LevelText() {
            ...
            _this.text0.scale = 0.8;
            _this.text0.enabled = true;
            _this.text0.pinned = true;
            _this.text0.str = "TAS - L " + (Game.Level.index < 10 ? "0" : "") + Game.Level.index;
    ...
    var SpeedrunTimer = /** @class */ (function (_super) {
        ...
        function SpeedrunTimer() {
            ...
            */
            ...
            _this.text.yAligned = Game.Y_ARROWS_GAME_BUTTONS + 1 + 10 + offset;
            return _this;
        }
...
(function (Game) {
    var FontManager = /** @class */ (function () {
        ...
        FontManager.createFondts = function () {
            ...
            FontManager.a.setFull(Game.Resources.textureMiniDash, 13, 307, 1);
            FontManager.b = new Utils.Font();
            FontManager.b.setFull(Game.Resources.textureMiniDash, 13, 348, 1);
            FontManager.c = new Utils.Font();
            FontManager.c.setFull(Game.Resources.textureMiniDash, 13, 389, 1);
            FontManager.ads = new Utils.Font();
            FontManager.ads.setFull(Game.Resources.textureMiniDash, 13, 430, 1);
        };
        return FontManager;
    }());
...
var Game;
(function (Game) {
    var PATH_BGM = "Assets/Audio/Komiku_-_01_-_Opening_.omw";
    var PATH_SFX_MDSH_JUMP = "Assets/Audio/mdsh-jump.wom";
    var PATH_SFX_MJMP_DASH = "Assets/Audio/mdsh-dash.wom";
    var PATH_SFX_MJMP_WALL = "Assets/Audio/mdsh-wall.wom";
    var PATH_SFX_MDSH_LOSE = "Assets/Audio/mdsh-lose.wom";
    var PATH_SFX_MDSH_WIN = "Assets/Audio/mdsh-win.wom";
    var PATH_SFX_MDSH_GROW = "Assets/Audio/mdsh-grow.wom";
    var PATH_SFX_MDSH_SHRINK = "Assets/Audio/mdsh-shrink.wom";
    Game.PATH_TEXTURE_GRAPHICS_MINI_DASH = "Assets/Graphics/MiniDash.png";
    ...
    Game.addPath("preload", Game.PATH_TEXTURE_GRAPHICS_MINI_DASH);
    ...
    Game.addPath("load", PATH_SFX_MDSH_JUMP);
    Game.addPath("load", PATH_SFX_MJMP_DASH);
    Game.addPath("load", PATH_SFX_MJMP_WALL);
    Game.addPath("load", PATH_SFX_MDSH_LOSE);
    Game.addPath("load", PATH_SFX_MDSH_WIN);
    Game.addPath("load", PATH_SFX_MDSH_GROW);
    Game.addPath("load", PATH_SFX_MDSH_SHRINK);
    Game.addAction("preinit", function () {
        Resources.textureMiniDash = new Engine.Texture(Game.PATH_TEXTURE_GRAPHICS_MINI_DASH, true, false);
        Resources.textureMiniDash.preserved = true;
        if (Game.HAS_LINKS && Game.HAS_GOOGLE_PLAY_LOGOS) {
    ...
    Game.addAction("configure", function () {
        ...
        Resources.bgm.volume = Resources.bgm.restoreVolume = 0.4 * vscale2;
        ...
        Resources.bgm.loopEnd = 44.8; //540;
        Game.bgms.push(Resources.bgm);
        Resources.sfxMDshJump = new Engine.AudioPlayer(PATH_SFX_MDSH_JUMP);
        Resources.sfxMDshJump.preserved = true;
        Resources.sfxMDshJump.volume = Resources.sfxMDshJump.restoreVolume = 2.80 * vscale;
        Game.sfxs.push(Resources.sfxMDshJump);
        Resources.sfxMDshDash = new Engine.AudioPlayer(PATH_SFX_MJMP_DASH);
        Resources.sfxMDshDash.preserved = true;
        Resources.sfxMDshDash.volume = Resources.sfxMDshDash.restoreVolume = 1.30 * vscale;
        Game.sfxs.push(Resources.sfxMDshDash);
        Resources.sfxMDshWall = new Engine.AudioPlayer(PATH_SFX_MJMP_WALL);
        Resources.sfxMDshWall.preserved = true;
        Resources.sfxMDshWall.volume = Resources.sfxMDshWall.restoreVolume = 2.30 * vscale;
        Game.sfxs.push(Resources.sfxMDshWall);
        Resources.sfxMDshLose = new Engine.AudioPlayer(PATH_SFX_MDSH_LOSE);
        Resources.sfxMDshLose.preserved = true;
        Resources.sfxMDshLose.volume = Resources.sfxMDshLose.restoreVolume = 1.50 * vscale;
        Game.sfxs.push(Resources.sfxMDshLose);
        Resources.sfxMDshWin = new Engine.AudioPlayer(PATH_SFX_MDSH_WIN);
        Resources.sfxMDshWin.preserved = true;
        Resources.sfxMDshWin.volume = Resources.sfxMDshWin.restoreVolume = 1.50 * vscale;
        Game.sfxs.push(Resources.sfxMDshWin);
        Resources.sfxMDshGrow = new Engine.AudioPlayer(PATH_SFX_MDSH_GROW);
        Resources.sfxMDshGrow.preserved = true;
        Resources.sfxMDshGrow.volume = Resources.sfxMDshGrow.restoreVolume = 2.00 * vscale;
        Game.sfxs.push(Resources.sfxMDshGrow);
        Resources.sfxMDshShrink = new Engine.AudioPlayer(PATH_SFX_MDSH_SHRINK);
        Resources.sfxMDshShrink.preserved = true;
        Resources.sfxMDshShrink.volume = Resources.sfxMDshShrink.restoreVolume = 2.00 * vscale;
        Game.sfxs.push(Resources.sfxMDshShrink);
...
(function (Utils) {
    var Text = /** @class */ (function (_super) {
        ...
        function Text() {
            ...
            _this.underline2.setColorUV(Game.Resources.textureMiniDash, 201, 3, 1);
        ...
        Object.defineProperty(ColorDialog.prototype, "style", {
            ...
            */
            ...
            set: function (style) {
                ...
                switch (style) {
                    case "normal":
                        this.leftShadow.setColorUV(Game.Resources.textureMiniDash, 201, 3, 1);
                        this.downBand.setColorUV(Game.Resources.textureMiniDash, 201, 3, 1);
                        this.up.setColorUV(Game.Resources.textureMiniDash, 212, 3, 1);
                        this.left.setColorUV(Game.Resources.textureMiniDash, 212, 3, 1);
                        this.right.setColorUV(Game.Resources.textureMiniDash, 212, 3, 1);
                        this.down.setColorUV(Game.Resources.textureMiniDash, 212, 3, 1);
                        this.fill.setColorUV(Game.Resources.textureMiniDash, 223, 3, 1);
                        this.upLight.setColorUV(Game.Resources.textureMiniDash, 234, 3, 1);
                        this.rightLight.setColorUV(Game.Resources.textureMiniDash, 234, 3, 1);
                        break;
                    case "purple":
                        this.leftShadow.setColorUV(Game.Resources.textureMiniDash, 201, 14, 1);
                        this.downBand.setColorUV(Game.Resources.textureMiniDash, 201, 14, 1);
                        this.up.setColorUV(Game.Resources.textureMiniDash, 212, 14, 1);
                        this.left.setColorUV(Game.Resources.textureMiniDash, 212, 14, 1);
                        this.right.setColorUV(Game.Resources.textureMiniDash, 212, 14, 1);
                        this.down.setColorUV(Game.Resources.textureMiniDash, 212, 14, 1);
                        this.fill.setColorUV(Game.Resources.textureMiniDash, 223, 14, 1);
                        this.upLight.setColorUV(Game.Resources.textureMiniDash, 234, 14, 1);
                        this.rightLight.setColorUV(Game.Resources.textureMiniDash, 234, 14, 1);
                        break;
                    case "clearblue":
                        this.leftShadow.setColorUV(Game.Resources.textureMiniDash, 201, 25, 1);
                        this.downBand.setColorUV(Game.Resources.textureMiniDash, 201, 25, 1);
                        this.up.setColorUV(Game.Resources.textureMiniDash, 212, 25, 1);
                        this.left.setColorUV(Game.Resources.textureMiniDash, 212, 25, 1);
                        this.right.setColorUV(Game.Resources.textureMiniDash, 212, 25, 1);
                        this.down.setColorUV(Game.Resources.textureMiniDash, 212, 25, 1);
                        this.fill.setColorUV(Game.Resources.textureMiniDash, 223, 25, 1);
                        this.upLight.setColorUV(Game.Resources.textureMiniDash, 234, 25, 1);
                        this.rightLight.setColorUV(Game.Resources.textureMiniDash, 234, 25, 1);
                        break;
                }
            },
            enumerable: false,
...
(function (Game) {
    ...
    var LoadingBar = /** @class */ (function (_super) {
        ...
        LoadingBar.prototype.setShadowColor = function (_red, _green, _blue, _alpha) {
            this.upShadow.setColorUV(Game.Resources.textureMiniDash, 201, 3, 1);
            this.leftShadow.setColorUV(Game.Resources.textureMiniDash, 201, 3, 1);
            this.rightShadow.setColorUV(Game.Resources.textureMiniDash, 201, 3, 1);
            this.downShadow.setColorUV(Game.Resources.textureMiniDash, 201, 3, 1);
        };
...
(function (Game) {
    var TutorialA = /** @class */ (function (_super) {
        ...
        function TutorialA() {
            var _this = _super.call(this) || this;
            var pos = -20 - 11 - 10 - 3 + 1.5 + 4;
            new Game.ColorDialog("normal", 0, pos - 6, Game.IS_TOUCH ? 144 : 126, 34);
            var text0 = new Utils.Text();
            text0.font = Game.FontManager.a;
            text0.scale = 1;
            text0.enabled = true;
            text0.pinned = true;
            text0.str = Game.IS_TOUCH ? "1. TOUCH THE LEFT SIDE OF THE" : "1. X OR LEFT CLICK";
            text0.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text0.xAlignView = Utils.AnchorAlignment.MIDDLE;
            text0.yAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text0.yAlignView = Utils.AnchorAlignment.MIDDLE;
            ...
            text1.enabled = true;
            text1.pinned = true;
            text1.str = Game.IS_TOUCH ? "SCREEN TO JUMP!" : "TO JUMP!";
            text1.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text1.xAlignView = Utils.AnchorAlignment.MIDDLE;
            text1.yAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text1.yAlignView = Utils.AnchorAlignment.MIDDLE;
            ...
            text2.enabled = true;
            text2.pinned = true;
            text2.str = Game.IS_TOUCH ? "2. TOUCH THE LEFT SIDE OF THE" : "2. X OR LEFT CLICK IN AIR";
            ...
            text2.xAligned = 0;
            text2.yAligned = pos + 15;
            var text3 = new Utils.Text();
            text3.font = Game.FontManager.a;
            text3.scale = 1;
            text3.enabled = true;
            text3.pinned = true;
            text3.str = Game.IS_TOUCH ? "SCREEN IN AIR TO DASH LEFT!" : "TO DASH LEFT!";
    ...
    var TutorialB = /** @class */ (function (_super) {
        ...
        function TutorialB() {
            var _this = _super.call(this) || this;
            var pos = -20 - 11 - 10 - 3 + 1.5 + 0 - 0.5;
            new Game.ColorDialog("normal", 0, pos - 6, Game.IS_TOUCH ? 144 + 8 : 128, 34);
            var text0 = new Utils.Text();
            text0.font = Game.FontManager.a;
            text0.scale = 1;
            text0.enabled = true;
            text0.pinned = true;
            text0.str = Game.IS_TOUCH ? "3. ALSO YOU CAN TOUCH THE RIGHT" : "3. ALSO YOU CAN USE C OR";
            text0.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text0.xAlignView = Utils.AnchorAlignment.MIDDLE;
            text0.yAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text0.yAlignView = Utils.AnchorAlignment.MIDDLE;
            ...
            text1.enabled = true;
            text1.pinned = true;
            text1.str = Game.IS_TOUCH ? "SIDE OF THE SCREEN TO JUMP!" : "RIGHT CLICK TO JUMP!";
            text1.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text1.xAlignView = Utils.AnchorAlignment.MIDDLE;
            text1.yAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text1.yAlignView = Utils.AnchorAlignment.MIDDLE;
            ...
            text2.enabled = true;
            text2.pinned = true;
            text2.str = Game.IS_TOUCH ? "4. TOUCH THE RIGHT SIDE OF THE" : "4. C OR RIGHT CLICK IN AIR";
            text2.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text2.xAlignView = Utils.AnchorAlignment.MIDDLE;
            text2.yAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text2.yAlignView = Utils.AnchorAlignment.MIDDLE;
            ...
            text3.enabled = true;
            text3.pinned = true;
            text3.str = Game.IS_TOUCH ? "SCREEN IN AIR TO DASH RIGHT!" : "TO DASH RIGHT!";
            text3.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text3.xAlignView = Utils.AnchorAlignment.MIDDLE;
            text3.yAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text3.yAlignView = Utils.AnchorAlignment.MIDDLE;
    ...
    var TutorialC = /** @class */ (function (_super) {
        ...
        function TutorialC() {
            var _this = _super.call(this) || this;
            var pos = -20 - 11 - 10 - 3 + 1.5 + 0.5 + 4;
            new Game.ColorDialog("normal", 0, pos - 6, Game.IS_TOUCH ? 144 - 48 : 116, 19);
            var text0 = new Utils.Text();
            text0.font = Game.FontManager.a;
            text0.scale = 1;
            text0.enabled = true;
            text0.pinned = true;
            text0.str = Game.IS_TOUCH ? "5. HOLD YOUR TOUCHS" : "5. HOLD ANY JUMP BUTTON";
            text0.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text0.xAlignView = Utils.AnchorAlignment.MIDDLE;
            text0.yAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text0.yAlignView = Utils.AnchorAlignment.MIDDLE;
    ...
    var TutorialD = /** @class */ (function (_super) {
        ...
        function TutorialD() {
            ...
            if (Game.IS_TOUCH)
                return _this;
            var pos = -20 - 11 - 10 - 3 + 1.5 + 0.5 + 4;
            new Game.ColorDialog("normal", 0, pos - 6, 70 - 4, 19 - 7);
            var text0 = new Utils.Text();
            text0.font = Game.FontManager.a;
            text0.scale = 1;
            text0.enabled = true;
            text0.pinned = true;
            text0.str = "6. R TO RESET";
            text0.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text0.xAlignView = Utils.AnchorAlignment.MIDDLE;
            text0.yAlignBounds = Utils.AnchorAlignment.MIDDLE;
            text0.yAlignView = Utils.AnchorAlignment.MIDDLE;
...
(function (Game) {
    ...
    Game.addAction("configure", function () {
        Game.FRAMES_BLOB = Game.FrameSelector.complex("blob sprites", Game.Resources.textureMiniDash, 13, 46);
        anims.stand = new Utils.Animation("stand", true, Game.FRAMES_BLOB, 10, [1, 2, 3, 2], null);
        anims.move = new Utils.Animation("move", true, Game.FRAMES_BLOB, 5, [1, 2, 3, 2], null);
        anims.ascend = new Utils.Animation("ascend", false, Game.FRAMES_BLOB, 3, [8, 9], null);
        anims.fallAscend = new Utils.Animation("fall ascend", false, Game.FRAMES_BLOB, 5, [10, 11], null);
        anims.fall = new Utils.Animation("fall", false, Game.FRAMES_BLOB, 5, [10, 11], null);
        anims.landing = new Utils.Animation("landing", false, Game.FRAMES_BLOB, 3, [12, 13, 14, 15, 3, 2], null);
        anims.dash = new Utils.Animation("dash", true, Game.FRAMES_BLOB, 3, [17, 18, 17, 16], null);
    });
    var Blob = /** @class */ (function (_super) {
        ...
        function Blob(def, color) {
            ...
            _this.color = color;
            Game.FRAMES_BLOB[0].applyToBox(_this.boxSolid);
            Game.FRAMES_BLOB[0].applyToBox(_this.boxOverlap);
            ///this.xVelMove = VEL_MOVE;
            _this.initAnimations();
            _this.initEmitters();
            _this.sfxJump = Game.Resources.sfxMDshJump;
            _this.sfxFall = Game.Resources.sfxMDshDash;
        ...
        Blob.prototype.initStates = function () {
            ...
            this.stateDash = new Game.Flow.State(this, "dash");
            ...
            this.stateDash.addLink(this.stateDead, function () { return _this.imDead(); });
            ...
            this.stateAscend.addLink(this.stateDash, function () { return _this.canDash && !_this.hasDashed && _this.jumpControlPressed; });
            this.stateFall.addLink(this.stateDash, function () { return _this.canDash && !_this.hasDashed && _this.jumpControlPressed; });
            this.stateDash.onReady = function () {
                _this.consumeJumpControls();
                _this.animator.setAnimation(anims.dash);
                _this.xVel = (Game.LastScene.instance == null ? VEL_DASH : VEL_DASH_LAST) * (_this.sprite.xMirror ? -1 : 1);
                _this.yScaleForceWorld = 0;
                _this.yVel = 0;
                _this.hasDashed = true;
                Game.Resources.sfxMDshDash.play();
            };
            this.stateDash.onStepUpdate = function () {
                _this.xVel = (Game.LastScene.instance == null ? VEL_DASH : VEL_DASH_LAST) * (_this.sprite.xMirror ? -1 : 1);
            };
            this.stateDash.onExit = function () {
                _this.xVel = 0;
                if (_this.machine.nextState == _this.stateFall || Game.LastScene.instance != null) {
                    _this.onWallDashHit();
                    Game.LevelShake.trigger();
                    Game.Resources.sfxMDshWall.play();
                }
                _this.yScaleForceWorld = 1;
            };
            this.stateDash.addLink(this.stateDead, function () { return _this.xContacts != null && Game.LastScene.instance != null; });
            this.stateDash.addLink(this.stateFall, function () { return _this.xContacts != null; });
            ...
            this.stateDead.onEnter = function () {
                ...
                _this.onBlobDead();
                Game.Resources.sfxMDshLose.play();
            };
            ...
            this.machine.anyState.onStepUpdate = function () {
                ...
                if (_this.machine.currentState == _this.stateAscend || _this.machine.currentState == _this.stateFall) {
                    _this.canDash = true;
                }
                else {
                    _this.canDash = false;
                }
                if (_this.yDirContact > 0) {
                    _this.hasDashed = false;
                }
            };
        ...
        Blob.prototype.onWallDashHit = function () {
        };
        ...
        Blob.prototype.onReset = function () {
            _super.prototype.onReset.call(this);
            this.fixFrames(Game.FRAMES_BLOB);
            this.yScaleForceWorld = 1;
            this.boxSolid.enabled = true;
        ...
        Blob.prototype.onSetFrame = function (_animator, _animation, _frame) {
            ...
            Game.FRAMES_BLOB[_animation.indexArray[_animator.indexFrame] + Game.OFFSET_COLOR_BLOB + 5].applyToSprite(this.sprite);
...
var Game;
(function (Game) {
    var DashControls = /** @class */ (function (_super) {
        __extends(DashControls, _super);
        function DashControls() {
            var _this = _super.call(this) || this;
            _this.right = new Game.Control();
            _this.right.enabled = true;
            _this.right.freezeable = true;
            _this.right.listener = _this;
            _this.right.useKeyboard = true;
            _this.right.newInteractionRequired = true;
            _this.right.useMouse = true;
            _this.right.mouseButtons = [0];
            _this.right.keys = [Engine.Keyboard.D, Engine.Keyboard.RIGHT, "right", "Right"];
            _this.left = new Game.Control();
            _this.left.enabled = true;
            _this.left.freezeable = true;
            _this.left.listener = _this;
            _this.left.useKeyboard = true;
            _this.left.newInteractionRequired = true;
            _this.left.useMouse = true;
            _this.left.mouseButtons = [2];
            _this.left.keys = [Engine.Keyboard.A, Engine.Keyboard.LEFT, "right", "Right"];
            if (Game.IS_TOUCH) {
                _this.right.useTouch = true;
                _this.right.bounds = new Engine.Sprite();
                _this.right.bounds.enabled = true;
                _this.right.bounds.pinned = true;
                _this.left.useTouch = true;
                _this.left.bounds = new Engine.Sprite();
                _this.left.bounds.enabled = true;
                _this.left.bounds.pinned = true;
                _this.tryFixTouchControls();
            }
            return _this;
        }
        DashControls.prototype.onReset = function () {
            this.disable();
        };
        DashControls.prototype.enable = function () {
            this.left.enabled = true;
            this.right.enabled = true;
        };
        DashControls.prototype.disable = function () {
            this.left.enabled = false;
            this.right.enabled = false;
        };
        DashControls.prototype.onViewUpdate = function () {
            this.tryFixTouchControls();
        };
        DashControls.prototype.tryFixTouchControls = function () {
            if (Game.IS_TOUCH) {
                this.right.bounds.y = -Engine.Renderer.ySizeView * 0.5;
                this.right.bounds.xSize = Engine.Renderer.xSizeView * 0.5;
                this.right.bounds.ySize = Engine.Renderer.ySizeView;
                this.left.bounds.x = -Engine.Renderer.xSizeView * 0.5;
                this.left.bounds.y = -Engine.Renderer.ySizeView * 0.5;
                this.left.bounds.xSize = Engine.Renderer.xSizeView * 0.5;
                this.left.bounds.ySize = Engine.Renderer.ySizeView;
            }
        };
        return DashControls;
    }(Engine.Entity));
    Game.DashControls = DashControls;
})(Game || (Game = {}));
...
(function (Game) {
    ...
    var ANIM;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("goal", Game.Resources.textureMiniDash, 280, 76);
        ANIM = new Utils.Animation("stand", true, FRAMES, 5, [1, 2, 3, 4, 5, 6, 7, 8], null);
    });
    var Goal = /** @class */ (function (_super) {
        __extends(Goal, _super);
        function Goal(def) {
        ...
        Goal.prototype.onOverlapUpdate = function () {
            if (!Game.SceneFreezer.stoped) {
                ...
                if (this.boxSolid.collideAgainst(Game.Player.instance.boxSolid, null, true, 0, false, Engine.Box.LAYER_ALL) != null) {
                    ...
                    this.animator.setCurrentFrame();
                    Game.Resources.sfxMDshWin.play();
                    Goal.got++;
                }
            }
        };
...
var Game;
(function (Game) {
    var JumpLeftControl = /** @class */ (function (_super) {
        __extends(JumpLeftControl, _super);
        function JumpLeftControl() {
            var _this = _super.call(this) || this;
            _this.countStepsDelayAction = 0;
            _this.stepsDelayAction = 5;
            _this.control = new Game.Control();
            ...
            _this.control.listener = _this;
            _this.control.useKeyboard = true;
            _this.control.keys = [Engine.Keyboard.X];
            _this.control.newInteractionRequired = true;
            _this.control.useMouse = true;
            _this.control.mouseButtons = [0];
            _this.control.useTouch = true;
            if (Game.IS_TOUCH) {
                _this.control.useTouch = true;
                _this.control.bounds = new Engine.Sprite();
                _this.control.bounds.enabled = true;
                _this.control.bounds.pinned = true;
                _this.tryFixTouchControls();
            }
            return _this;
        }
        Object.defineProperty(JumpLeftControl.prototype, "pressedDelayedAction", {
            get: function () {
                return this.countStepsDelayAction > 0;
            },
            enumerable: false,
        ...
        Object.defineProperty(JumpLeftControl.prototype, "pressedAction", {
            get: function () {
                return this.control.pressed;
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(JumpLeftControl.prototype, "downAction", {
            get: function () {
        ...
        JumpLeftControl.prototype.onReset = function () {
            this.countStepsDelayAction = 0;
        };
        JumpLeftControl.prototype.onViewUpdate = function () {
            this.tryFixTouchControls();
        };
        JumpLeftControl.prototype.tryFixTouchControls = function () {
            if (Game.IS_TOUCH) {
                this.control.bounds.x = -Engine.Renderer.xSizeView * 0.5;
                this.control.bounds.y = -Engine.Renderer.ySizeView * 0.5;
                this.control.bounds.xSize = Engine.Renderer.xSizeView * 0.5;
                this.control.bounds.ySize = Engine.Renderer.ySizeView;
            }
        };
        JumpLeftControl.prototype.onStepUpdate = function () {
            if (!Game.SceneFreezer.stoped) {
                this.countStepsDelayAction -= (this.countStepsDelayAction > 0 ? 1 : 0);
        ...
        JumpLeftControl.prototype.consumeDelayedAction = function () {
            this.countStepsDelayAction = 0;
        };
        return JumpLeftControl;
    }(Engine.Entity));
    Game.JumpLeftControl = JumpLeftControl;
})(Game || (Game = {}));
///<reference path="../../Engine/Entity.ts"/>
var Game;
(function (Game) {
    var JumpRightControl = /** @class */ (function (_super) {
        __extends(JumpRightControl, _super);
        function JumpRightControl() {
            var _this = _super.call(this) || this;
            _this.countStepsDelayAction = 0;
            _this.stepsDelayAction = 5;
            _this.control = new Game.Control();
            ...
            _this.control.listener = _this;
            _this.control.useKeyboard = true;
            _this.control.keys = [Engine.Keyboard.C];
            _this.control.newInteractionRequired = true;
            _this.control.useMouse = true;
            _this.control.mouseButtons = [2];
            _this.control.useTouch = true;
            if (Game.IS_TOUCH) {
                _this.control.useTouch = true;
                _this.control.bounds = new Engine.Sprite();
        ...
        Object.defineProperty(JumpRightControl.prototype, "pressedDelayedAction", {
            get: function () {
                return this.countStepsDelayAction > 0;
            },
            enumerable: false,
        ...
        Object.defineProperty(JumpRightControl.prototype, "pressedAction", {
            get: function () {
                return this.control.pressed;
            },
            enumerable: false,
        ...
        Object.defineProperty(JumpRightControl.prototype, "downAction", {
            get: function () {
                return this.control.down;
            },
            enumerable: false,
        ...
        JumpRightControl.prototype.onReset = function () {
            this.countStepsDelayAction = 0;
        };
        JumpRightControl.prototype.onViewUpdate = function () {
            this.tryFixTouchControls();
        };
        JumpRightControl.prototype.tryFixTouchControls = function () {
            if (Game.IS_TOUCH) {
                this.control.bounds.y = -Engine.Renderer.ySizeView * 0.5;
                this.control.bounds.xSize = Engine.Renderer.xSizeView * 0.5;
                this.control.bounds.ySize = Engine.Renderer.ySizeView;
        ...
        JumpRightControl.prototype.onStepUpdate = function () {
            if (!Game.SceneFreezer.stoped) {
                this.countStepsDelayAction -= (this.countStepsDelayAction > 0 ? 1 : 0);
                if (this.control.pressed) {
                    this.countStepsDelayAction = this.stepsDelayAction;
        ...
        JumpRightControl.prototype.consumeDelayedAction = function () {
            this.countStepsDelayAction = 0;
        };
        return JumpRightControl;
    }(Engine.Entity));
    Game.JumpRightControl = JumpRightControl;
})(Game || (Game = {}));
var Game;
(function (Game) {
    ...
    var FRAMES_GOAL;
    Game.addAction("configure", function () {
        FRAMES_GOAL = Game.FrameSelector.complex("goal particles", Game.Resources.textureMiniDash, 280, 93);
    });
    ...
    var FRAMES_PLAYER;
    Game.addAction("configure", function () {
        FRAMES_PLAYER = Game.FrameSelector.complex("playerexploparticles", Game.Resources.textureMiniDash, 344, 93);
    });
    ...
    var FRAMES_ENEMY;
    Game.addAction("configure", function () {
        FRAMES_ENEMY = Game.FrameSelector.complex("enemyexploparticles", Game.Resources.textureMiniDash, 344, 93);
    });
    ...
    var FRAMES_WALL;
    Game.addAction("configure", function () {
        FRAMES_WALL = Game.FrameSelector.complex("wallparticles", Game.Resources.textureMiniDash, 312, 93);
    });
    var WallParticle = /** @class */ (function (_super) {
        __extends(WallParticle, _super);
        function WallParticle(emitter) {
            var _this = _super.call(this, emitter) || this;
            _this.countSteps = 0;
            _this.parentRelative = false;
            return _this;
        }
        Object.defineProperty(WallParticle.prototype, "xRange", {
            get: function () {
                return 0;
            },
            enumerable: false,
        ...
        Object.defineProperty(WallParticle.prototype, "yRange", {
            get: function () {
                return 0;
            },
            enumerable: false,
        ...
        Object.defineProperty(WallParticle.prototype, "xRangeVel", {
            get: function () {
                return this.wallDir;
            },
            enumerable: false,
        ...
        Object.defineProperty(WallParticle.prototype, "yRangeVel", {
            get: function () {
                if (this.index % 3 == 0) {
                    return 1;
                }
        ...
        Object.defineProperty(WallParticle.prototype, "xRangeAccel", {
            get: function () {
                return 0;
            },
            enumerable: false,
        ...
        Object.defineProperty(WallParticle.prototype, "yRangeAccel", {
            get: function () {
                return 0;
            },
            enumerable: false,
        ...
        Object.defineProperty(WallParticle.prototype, "rangeLife", {
            get: function () {
                return 300;
            },
            enumerable: false,
        ...
        WallParticle.prototype.onReset = function () {
            _super.prototype.onReset.call(this);
            this.countSteps = 0;
        };
        WallParticle.prototype.emitt = function (index) {
            _super.prototype.emitt.call(this, index);
            FRAMES_WALL[0].applyToSprite(this.sprite);
            this.countSteps = 0;
        };
        WallParticle.prototype.onStepUpdate = function () {
            _super.prototype.onStepUpdate.call(this);
            if (this.enabled && !Game.SceneFreezer.stoped) {
                if (this.countSteps == WallParticle.STEPS) {
                    FRAMES_WALL[1].applyToSprite(this.sprite);
                }
                else if (this.countSteps == WallParticle.STEPS * 2) {
                    FRAMES_WALL[2].applyToSprite(this.sprite);
                }
                else if (this.countSteps == WallParticle.STEPS * 3) {
                    FRAMES_WALL[3].applyToSprite(this.sprite);
                }
                this.countSteps += 1;
            }
        };
        WallParticle.prototype.onDrawParticles = function () {
        };
        WallParticle.prototype.onDrawGoalParticlesFrontUnpaused = function () {
            if (!Game.SceneFreezer.stoped) {
                this.sprite.render();
            }
        };
        WallParticle.prototype.onDrawGoalParticlesFrontPaused = function () {
            if (Game.SceneFreezer.stoped) {
                this.sprite.render();
            }
        };
        WallParticle.STEPS = 4;
        return WallParticle;
    }(Game.Emission.SimpleParticle));
    Game.WallParticle = WallParticle;
    var WallParticleLeft = /** @class */ (function (_super) {
        __extends(WallParticleLeft, _super);
        function WallParticleLeft(emitter) {
            var _this = _super.call(this, emitter) || this;
            _this.wallDir = 1;
            return _this;
        }
        return WallParticleLeft;
    }(WallParticle));
    Game.WallParticleLeft = WallParticleLeft;
    var WallParticleRight = /** @class */ (function (_super) {
        __extends(WallParticleRight, _super);
        function WallParticleRight(emitter) {
            var _this = _super.call(this, emitter) || this;
            _this.wallDir = -1;
            return _this;
        }
        return WallParticleRight;
    }(WallParticle));
    Game.WallParticleRight = WallParticleRight;
})(Game || (Game = {}));
///<reference path="Blob.ts"/>
var Game;
(function (Game) {
...
(function (Game) {
    var FRAMES;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("platforms", Game.Resources.textureMiniDash, 242, 110);
    });
    var Platform = /** @class */ (function (_super) {
        __extends(Platform, _super);
...
(function (Game) {
    ...
    var Player = /** @class */ (function (_super) {
        ...
        function Player(def) {
            ...
            _this.jumpRightControl = new Game.JumpRightControl();
            _this.jumpLeftControl = new Game.JumpLeftControl();
            _this.stepsWin = 35 * 1;
            _this.stepsLoss = 35 * 1;
            _this.flipOnAbyss = false;
            _this.flipOnWall = false;
            _this.canStick = false;
            _this.mainmenu = _this.getProperty("mainmenu");
            _this.emitterWallLeft = new Game.Emission.Emitter(Game.WallParticleLeft, 6);
            _this.emitterWallLeft.sizeEmission = 3;
            _this.emitterWallRight = new Game.Emission.Emitter(Game.WallParticleRight, 6);
            _this.emitterWallRight.sizeEmission = 3;
            return _this;
        }
        ...
        Object.defineProperty(Player.prototype, "jumpControlPressed", {
            get: function () {
                if (this.mainmenu)
                    return false;
                if (this.jumpRightControl.pressedDelayedAction) {
                    this.sprite.xMirror = false;
                    return true;
                }
                else if (this.jumpLeftControl.pressedDelayedAction) {
        ...
        Object.defineProperty(Player.prototype, "jumpControlDown", {
            get: function () {
                return this.jumpRightControl.downAction || this.jumpLeftControl.downAction;
            },
            enumerable: false,
            configurable: true
        });
        ...
        */
        ...
        Player.prototype.onWallDashHit = function () {
            if (this.sprite.xMirror) {
                this.emitterWallLeft.x = this.boxSolid.x - this.boxSolid.xSize * 0.5;
                this.emitterWallLeft.y = this.boxSolid.y - this.boxSolid.ySize * 0.5;
                this.emitterWallLeft.emittChunk();
            }
            else {
                this.emitterWallRight.x = this.boxSolid.x + this.boxSolid.xSize * 0.5;
                this.emitterWallRight.y = this.boxSolid.y - this.boxSolid.ySize * 0.5;
                this.emitterWallRight.emittChunk();
            }
        };
        Player.prototype.consumeJumpControls = function () {
            this.jumpRightControl.consumeDelayedAction();
            this.jumpLeftControl.consumeDelayedAction();
        };
        ...
        Player.prototype.onSetFrame = function (_animator, _animation, _frame) {
            if (this.machine.currentState == this.stateFall && this.machine.oldState == this.stateDash) {
                Game.FRAMES_BLOB[_animation.indexArray[_animator.indexFrame] + 9].applyToSprite(this.sprite);
            }
            else {
                Game.FRAMES_BLOB[_animation.indexArray[_animator.indexFrame]].applyToSprite(this.sprite);
            }
        };
        return Player;
    }(Game.Blob));
...
(function (Game) {
    ...
    var ANIM;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("roller", Game.Resources.textureMiniDash, 13, 76);
...
(function (Game) {
    ...
    var ANIM_SHRINK;
    Game.addAction("configure", function () {
        FRAMES = Game.FrameSelector.complex("slimespike", Game.Resources.textureMiniDash, 218, 307);
        ANIM_SMALL = new Utils.Animation("small", true, FRAMES, 10, [0, 1, 2, 1], null);
        ANIM_GROW = new Utils.Animation("grow", false, FRAMES, 1, [1, 2, 3, 4, 3, 2, 1, 0, 5, 6, 7, 8, 9], null);
        ANIM_TALL = new Utils.Animation("tall", true, FRAMES, 10, [9, 10, 11, 10], null);
        ANIM_SHRINK = new Utils.Animation("shrink", false, FRAMES, 1, [10, 9, 8, 7, 6, 5, 0, 1, 2, 3, 4, 3, 2, 1, 0], null);
    });
    var SlimeSpike = /** @class */ (function (_super) {
        __extends(SlimeSpike, _super);
        function SlimeSpike(def) {
            var _this = _super.call(this, def) || this;
            Game.SceneMap.instance.boxesEnemies.push(_this.boxSolid);
            _this.xScaleForceWorld = 0;
            _this.yScaleForceWorld = 0;
        ...
        SlimeSpike.prototype.initState = function () {
            var _this = this;
            ...
            grow.onStepUpdate = function () {
                ...
                if (_this.stepCount == 5) {
                    Game.Resources.sfxMDshGrow.play();
                }
            };
            ...
            shrink.onReady = function () {
                ...
                Game.Resources.sfxMDshShrink.play();
            };
        ...
        SlimeSpike.prototype.onReset = function () {
            _super.prototype.onReset.call(this);
        };
        SlimeSpike.prototype.onStart = function () {
            var contacts = this.boxSolid.collide(Game.SceneMap.instance.boxesSolids, null, false, 0, false, Engine.Box.LAYER_ALL);
            if (contacts != null) {
        ...
        SlimeSpike.prototype.xMoveOnPlatform = function (dist) {
            this.boxSolid.x += dist;
        };
        SlimeSpike.prototype.yMoveOnPlatform = function (dist) {
            this.boxSolid.y += dist;
        };
        SlimeSpike.prototype.onPlatformOverlapX = function () {
        };
        SlimeSpike.prototype.onPlatformOverlapY = function () {
        };
        SlimeSpike.prototype.onDrawObjectsBack = function () {
            if (this.platformParent != null) {
        ...
        SlimeSpike.prototype.onSetFrame = function (_animator, _animation, _frame) {
            if (this.vertical) {
                _frame.applyToSprite(this.sprite);
                ...
                FRAMES[_animation.indexArray[_animator.indexFrame] + 12].applyToSprite(this.sprite);
                FRAMES[_animation.indexArray[_animator.indexFrame] + 12].applyToBox(this.boxSolid);
                if (this.sprite.xMirror) {
                    this.boxSolid.xOffset = -this.boxSolid.xSize + 1;
                }
            }
        };
        SlimeSpike.prototype.onClearScene = function () {
            Game.Spike.boxes = [];
        };
        SlimeSpike.boxes = [];
        return SlimeSpike;
    }(Game.Arcade.WorldEntity));
    Game.SlimeSpike = SlimeSpike;
})(Game || (Game = {}));
///<reference path = "../../Game/Arcade/WorldEntity.ts"/>
var Game;
(function (Game) {
    ...
    var FRAME_0;
    Game.addAction("configure", function () {
        FRAME_0 = new Utils.AnimationFrame(Game.Resources.textureMiniDash, 3, 26, 8, 7, 0, 0, null, true, 6, 6, 1, 2);
    });
    ...
    var FRAME_90;
    Game.addAction("configure", function () {
        FRAME_90 = new Utils.AnimationFrame(Game.Resources.textureMiniDash, 4, 36, 7, 8, 0, 0, null, true, 6, 6, 2, 1);
    });
    ...
    var FRAME_180;
    Game.addAction("configure", function () {
        FRAME_180 = new Utils.AnimationFrame(Game.Resources.textureMiniDash, 3, 47, 8, 7, 0, 0, null, true, 6, 6, 1, -1);
    });
    ...
    var FRAME_270;
    Game.addAction("configure", function () {
        FRAME_270 = new Utils.AnimationFrame(Game.Resources.textureMiniDash, 3, 58, 7, 8, 0, 0, null, true, 6, 6, -1, 0);
    });
